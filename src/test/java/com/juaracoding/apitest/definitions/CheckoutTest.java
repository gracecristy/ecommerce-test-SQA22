...
public class CheckoutTest {
    ...
    @When("Klik tombol Continue")
    public void klik_tombol_continue() {
        System.out.println("CheckoutTest::Klik tombol Continue");
    }

    @Then("User diarahkan ke halaman proses Checkout")
    public void user_diarahkan_ke_halaman_proses_checkout() {
        System.out.println("CheckoutTest::User diarahkan ke halaman proses Checkout");
        }
